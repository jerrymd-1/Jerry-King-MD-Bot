/**
 * List Command - Display all available commands
 * Styled as per menu.js minimal design
 */
...
module.exports = {
  ...
  category: 'general',
  description: 'Show all available commands in a stylish format',
  usage: '.list',
  ...
  async execute(sock, msg, args, extra) {
    try {
      ...
      // Build header (exact same as menu.js)
      ...
      // Define category order and display names (same as menu.js)
      const categoryOrder = [
      ...
      // Send with image if available (same as menu.js)
